...
///////////////////////////
  ...
  const soloInnoving = useLocation();

  console.log("ENTRA EL STATE!: " + Object.keys(soloInnoving.state) +"--")
  const getUsers = async () => {
    const todo = await axios.get("http://localhost:3001/users/allDisabled",{params: {soloInnoving}});
